  ...
  <div style={{ backgroundColor: card, border: `1px solid ${border}` }} className="rounded-2xl p-6 shadow-lg">
    ...
    <div className="grid grid-cols-2 gap-4">
      <div style={{ backgroundColor: '#22c55e10', border: '1px solid #22c55e30' }} className="rounded-xl p-5 flex items-center gap-4">
        <CheckCircle className="w-6 h-6 sm:w-8 sm:h-8 flex-shrink-0" style={{ color: '#4ade80' }} />
        <div>
          <p style={{ color: '#4ade80' }} className="text-2xl sm:text-3xl font-black">{active}</p>
          <p style={{ color: '#4ade8099' }} className="text-sm mt-0.5">Attivi</p>
        </div>
      </div>
      <div style={{ backgroundColor: '#ef444410', border: '1px solid #ef444430' }} className="rounded-xl p-4 sm:p-5 flex items-center gap-3 sm:gap-4">
        <XCircle className="w-6 h-6 sm:w-8 sm:h-8 flex-shrink-0" style={{ color: '#f87171' }} />
        <div>
          <p style={{ color: '#f87171' }} className="text-2xl sm:text-3xl font-black">{expired}</p>
